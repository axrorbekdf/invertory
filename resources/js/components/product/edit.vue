                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="login-form">
                          ...
                          <form class="create" @submit.prevent="productUpdate" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="form-row">
                                  ...
                                  <div class="col-md-6">
                                    <label>Photo</label>
                                    <img :src="form.newimage" style="width: 75%; height: 160px; display: block; margin: 0px 5px 25px 5px;">

                                    <div class="custom-file">
                                        <input type="file" @change="onFileSelected" class="custom-file-input" id="customFile">
                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                        <span class="text-danger" v-if="errors.newimage">{{ errors.newimage[0] }}</span>
                                    </div>
                                  </div>
                                </div>
                            </div>
        ...
        methods:{
            ...
            onFileSelected(event){
              ...
              if(file.size > 1048770){
                ...
                reader.onload = (evt) => {
                  this.form.newimage = evt.target.result;
                };
          	...
          	productUpdate(){
              let id = this.$route.params.id;
	            axios.put('/api/products/'+id, this.form)
	            .then(res => {
