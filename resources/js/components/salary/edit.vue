                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="login-form">
                          ...
                          <form class="create" @submit.prevent="salaryUpdate">
                            <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                    <label>Amount</label>
                                    <input type="hidden" v-model="form.employee_id" i>
    ...
    export default {
        ...
        methods:{
            getSalary(){
              ...
              .then(({data}) => {
                this.form.name = data[0].employee.name;
                this.form.employee_id = data[0].employee.id;
                this.form.amount = data[0].amount;
                this.form.salary_date = data[0].salary_date;
                this.form.salary_month = data[0].salary_month;
                this.form.salary_year = data[0].salary_year;
              })
