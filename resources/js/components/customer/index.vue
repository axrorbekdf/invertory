<template>
    <div id="home">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
		    <router-link to="/store-customer" class="nav-link btn-primary">
		    	<h1 class="h3 mb-0 text-white-800">Add Customer</h1>
		    </router-link>
		    <ol class="breadcrumb">
	                  ...
	                  <table class="table align-items-center table-flush">
	                    ...
	                    <tbody>
	                      	<tr v-for="customer in filterSearch" :key="customer.id">
		                        ...
		                        <td><span class="badge badge-success">{{ customer.address }}</span></td>
		                        <td>
		                        	<router-link :to="{ name: 'edit-customer', params:{id: customer.id}}" @click="editEmployee(customer)" class="btn btn-sm btn-primary">Edit</router-link>
