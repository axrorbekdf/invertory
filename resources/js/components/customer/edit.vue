<template>
    <div id="employee-create">
      <div class="d-sm-flex align-items-center justify-content-between mb-1">
        <router-link to="/customers" class="nav-link btn-primary">
          <h1 class="h3 mb-0 text-white-800">All Customers</h1>
        </router-link>
        <ol class="breadcrumb">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="login-form">
                          ...
                          <form class="create" @submit.prevent="customerUpdate" enctype="multipart/form-data">
